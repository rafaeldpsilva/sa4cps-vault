...
The most important element of a paper is the title—think of the ratio of the number of titles you read to the number of papers you read. The title is typically the first element a reader encounters, so its quality [[3](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref003)] determines whether the reader will invest time in reading the abstract.
...
Because you are the world’s leading expert at exactly what you are doing, you are also the world’s least qualified person to judge your writing from the perspective of the naïve reader. The majority of writing mistakes stem from this predicament. Think like a designer—for each element, determine the impact that you want to have on people and then strive to achieve that objective [[4](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref004)]. Try to think through the paper like a naïve reader who must first be made to care about the problem you are addressing (see Rule 6) and then will want to understand your answer with minimal effort.
...
The vast knowledge base of human psychology is useful in paper writing. For example, people have working memory constraints in that they can only remember a small number of items and are better at remembering the beginning and the end of a list than the middle [[5](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref005)]. Do your best to minimize the number of loose threads that the reader has to keep in mind at any one time.
...
The individual parts of a paper—abstract, introduction, results, and discussion—have different objectives, and thus they each apply the C-C-C structure a little differently in order to achieve their objectives. We will discuss these specialized structures in this section and summarize them in [Fig 1](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi-1005619-g001).

[![thumbnail](https://journals.plos.org/ploscompbiol/article/figure/image?size=inline&id=10.1371/journal.pcbi.1005619.g001)](https://journals.plos.org/ploscompbiol/article/figure/image?size=medium&id=10.1371/journal.pcbi.1005619.g001 "Click for larger image")
...
[https://doi.org/10.1371/journal.pcbi.1005619.g001](https://doi.org/10.1371/journal.pcbi.1005619.g001)
...
There are multiple signs that further work is necessary on a manuscript (see [Table 1](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi-1005619-t001)). For example, if you, as the writer, cannot describe the entire outline of a paper to a colleague in a few minutes, then clearly a reader will not be able to. You need to further distill your story. Finding such violations of good writing helps to improve the paper at all levels.

[![thumbnail](https://journals.plos.org/ploscompbiol/article/figure/image?size=inline&id=10.1371/journal.pcbi.1005619.t001)](https://journals.plos.org/ploscompbiol/article/figure/image?size=medium&id=10.1371/journal.pcbi.1005619.t001 "Click for larger image")

Table 1. A summary of the ten rules and how to tell if they are being violated.

[https://doi.org/10.1371/journal.pcbi.1005619.t001](https://doi.org/10.1371/journal.pcbi.1005619.t001)
...
This paper focused on the structure, or “anatomy,” of manuscripts. We had to gloss over many finer points of writing, including word choice and grammar, the creative process, and collaboration. A paper about writing can never be complete; as such, there is a large body of literature dealing with issues of scientific writing [[9](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref009),[10](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref010),[11](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref011),[12](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref012),[13](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref013),[14](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref014),[15](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref015),[16](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref016),[17](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref017)].

Personal style often leads writers to deviate from a rigid, conserved structure, and it can be a delight to read a paper that creatively bends the rules. However, as with many other things in life, a thorough mastery of the standard rules is necessary to successfully bend them [[18](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005619#pcbi.1005619.ref018)]. In following these guidelines, scientists will be able to address a broad audience, bridge disciplines, and more effectively enable integrative science.