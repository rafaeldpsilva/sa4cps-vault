...
| Paper                                        | Occupant Dimension        | AI Method                         | Evolution         | Evaluation Type   | Multi-Occupant Conflict/Negotiation     |
| :------------------------------------------- | :------------------------ | :-------------------------------- | :---------------- | :---------------- | :-------------------------------------- |
...
**Papers Using Relational AI Methods** 
The following papers leverage relational AI, such as knowledge graphs (KGs), ontologies, Graph Neural Networks (GNNs), and the Semantic Web to map complex relationships and contexts:
...
**Papers Using Generative AI Methods** 
These papers employ Large Language Models (LLMs), foundation models, or NLP-based generation for reasoning, predicting behavior, or natural language generation:
...
**Papers Modeling Preference Change Over Time**
Several papers in the sources actively model how user preferences and profiles evolve over time:
...
**Triggers for Adaptation: Explicit Feedback, Implicit Behavioral Drift, and Context Change** 
Adaptation in these dynamic models is triggered by three primary mechanisms:
...
**Papers Treating Preferences as Static Profiles**
While dynamic modeling is growing, several systems still rely on static or fixed profiling:
...
**Papers Modeling Explicitly Stated Preferences**
Several papers describe systems that depend on direct user input, structured surveys, or explicitly declared choices to build user profiles:
...
**Papers Inferring Latent Intent or Unarticulated Needs**
A growing body of research moves away from explicit questionnaires, instead capturing unconscious heuristics, hidden goals, and unarticulated interests from behavioral traces:
...
**Methods Enabling Intent Inference**
To successfully uncover these latent intents, researchers employ several advanced computational methods:
